...
public class C07_MethodCreation {//motor

    public static void main(String[] args) {
        String name = "Haluk";
        System.out.println("car car "+name);
        C07_MethodDepo.gecmeNotu(24);// depoı class'tan class name ile method calistiriyoruz.
...
//  En son da parantez icinde not verisi tanıimlanir(Ör:24). Sonra main olan class calistirilir ve depoda yer alan method islem gorur, sonuc yazdirilmis olur.
        ...
        C07_MethodDepo.topla(3, 5);//8 Baska bir class icinde olan(C07MethodDepo) methoda atifta bulunuldu.
...
selamVer();// aynı class icinde methodName ile call edilir--> kendi koyumun iscisi.
    C06_MethodOverloading.topla(35,63);//98 baska bir class uzerinde yazilan bir method (recall) cagirildi.
    }// main disi
