...
public class C01_Ogretmen {
    ...
    public C01_Ogretmen(String isim, int tecrube) {//full parametreli constructor
        this.isim = isim;
        this.tecrube = tecrube;
    }

    public static void maasHesapla() {//static method
        System.out.println("agam helali hos olsun, afiyetle maasi harca :)");

    }

    public void evlilikYildonumu() {//non-static method
        System.out.println("Agam bir yastikta en az 40 yil ins :)");
    }
