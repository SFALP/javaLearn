public class Q09_NestedTernary {
    ...
    public static void main(String[] args) {
        ...
        */
        double a = 45;
        System.out.println(a % 5 == 0 && a % 8 == 0 ? ("Able to divide by 5 and 8") : (a % 10 == 5 && a % 9 == 0 ? ("Able to divide by 9 and divide by 10 reminder is 5") : ("Able NOT to divide by 9, divide by 10, divide by 5 and divide by 8")));
    }
}
